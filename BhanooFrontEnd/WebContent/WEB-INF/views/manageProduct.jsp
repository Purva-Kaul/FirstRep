<div class="row">
	...
	<div class="col-lg-12">
		...
		<form:form class="form-horizontal" modelAttribute="product"
			action="${cp}/manage/${actionURL}" method="post"
			...
			<fieldset>
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="name">Product
						Name</label>
					<div class="col-md-5">
						<form:input path="name" name="name" placeholder="Product Name"
							class="form-control input-md" required="" />
						<span class="help-block text-danger"><form:errors
								path="name" /></span>
					</div>
				</div>
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="brand">Product
						Brand</label>
					<div class="col-md-5">
						<form:input path="brand" name="brand" placeholder="Product Brand"
							class="form-control input-md" required="" />
						<span class="help-block"><form:errors path="brand" /></span>
					</div>
				</div>
				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="unitPrice">Unit
						Price</label>
					<div class="col-md-5">
						<form:input path="unitPrice" name="unitPrice"
							placeholder="Unit Price" class="form-control input-md"
							required="" />
						<span class="help-block"><form:errors path="unitPrice" /></span>
					</div>
				</div>
				<!-- Text input-->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<form:select path="categoryId" items="${categories}"
							itemLabel="name" itemValue="id" class="form-control input-md"></form:select>
				...
				<!-- Textarea -->
				<div class="form-group">
					<label class="col-md-4 control-label" for="file">Product Image</label>
					<div class="col-md-4">
						<form:input class="form-control" path="file" name="file" type="file"/>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						...
						<button id="cancle" type="reset" name="cancle"
		...
		<table border="2px">
			...
			<c:forEach items="${products}" var="product">
				<tr>
					<td>${product.id}</td>
					<td><img src="${cp}/assets/images/${product.code}.jpg" width="350px" height="200px"/></td>
					<td>${product.name}</td>
					<td>${product.brand}</td>
					...
					<td><a href="${cp}/manage/updateProduct/${product.id}">Edit</a>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form:form class="form-horizontal" modelAttribute="category"
					action="${cp}/manage/addCat" method="post">
					<fieldset>
						...
						<div class="form-group">
							<label class="col-md-6 control-label" for="name">Category
								Name</label>
							<div class="col-md-6">
								<form:input path="name" name="name" placeholder="Category Name"
									class="form-control input-md" required="" />
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								...
								<button id="cancle" type="reset" data-dismiss="modal"
									name="cancle" class="btn btn-danger">Reset</button>
							</div>
						</div>
